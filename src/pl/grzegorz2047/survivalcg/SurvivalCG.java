...
public class SurvivalCG extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Team freekill = util.getTeam(util.getFreeTag());
        freekill.setPrefix(util.getFreeTag());
        freekill.setDisplayName(util.getFreeTag());
        Team szeregowy = util.getTeam("Szeregowy");
        szeregowy.setPrefix(ChatColor.GRAY+"["+"Szeregowy"+ChatColor.GRAY+"]");
